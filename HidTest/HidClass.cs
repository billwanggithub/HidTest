...
class HidClass
{
    ...
    public static readonly List<FilterDeviceDefinition> HidDeviceDefinitions = new List<FilterDeviceDefinition>
        {
            new FilterDeviceDefinition( vendorId: 0x483, productId:0x5750 )
        };
    public static readonly List<FilterDeviceDefinition> UsbDeviceDefinitions = new()
        {
       new FilterDeviceDefinition( vendorId: 0x483, productId:0x5750 )
        };
    #endregion
    ...
    #region Constructor
    public HidClass(IDeviceFactory deviceManager, ILoggerFactory loggerFactory)
    {
